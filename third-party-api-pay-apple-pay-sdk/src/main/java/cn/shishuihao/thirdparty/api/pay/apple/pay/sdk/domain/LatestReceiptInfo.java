...
public class LatestReceiptInfo {
    ...
    private final String isUpgraded;
    /**
     * The reference name of a subscription offer that you configured
     ...
     * and Implementing Offer Codes in Your App.
     */
    @JsonProperty("offer_code_ref_name")
    private final String offerCodeRefName;
    /**
     * The time of the original app purchase, in a date-time format
     * similar to ISO 8601.
     */
    @JsonProperty("original_purchase_date")
    private final String originalPurchaseDate;
    /**
     * The time of the original app purchase, in UNIX epoch time format,
     * in milliseconds. Use this time format for processing dates.
     * For an auto-renewable subscription,
     * this value indicates the date of the subscription’s initial purchase.
     * The original purchase date applies to all product types
     * and remains the same in all transactions for the same product ID.
    ...
    /**
     * The identifier of the subscription group to
     * which the subscription belongs.
