...
import cn.shishuihao.thirdparty.api.pay.sdk.response.PayV1TransactionsAppResponse;
...
public interface AppPayApi extends CommonPayApi {
    /**
     * 统一下单.
     *
     ...
     */
    @RequestLine("POST /pay/v1/transactions/app")
    PayV1TransactionsAppResponse
    appPay(@Param("outTradeNo") String outTradeNo,
