...
import cn.shishuihao.thirdparty.api.pay.sdk.response.PayV1TransactionsNativeResponse;
import feign.Param;
...
public interface NativeApiPayApi extends CommonPayApi {
    /**
     * 统一下单.
     *
     ...
     */
    @RequestLine("POST /pay/v1/transactions/native")
    PayV1TransactionsNativeResponse
    nativePay(@Param("outTradeNo") String outTradeNo,
