...
class WechatFactoryTest {
    ...
    @Test
    void microPay() {
        WechatPayMicroPayResponse response = WechatFactory.Payment.codeApi().microPay(WechatPayMicroPayRequest.builder()
    ...
    @Test
    void orderQuery() {
        WechatPayOrderQueryResponse response = WechatFactory.Payment.commonApi().orderQuery(WechatPayOrderQueryRequest.builder()
                .appId("wx2421b1c4370ec43b")
                .mchId("10000100")
    ...
    @Test
    void refundQuery() {
        WechatPayRefundQueryResponse response = WechatFactory.Payment.commonApi().refundQuery(WechatPayRefundQueryRequest.builder()
                .appId("wx2421b1c4370ec43b")
                .mchId("10000100")
