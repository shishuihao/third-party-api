...
public abstract class AbstractWxPayXmlResponse {
    /**
     * 返回状态码 String(16) SUCCESS SUCCESS/FAIL 此字段是通信标识，非交易标识，交易是否成功需要查看trade_state来判断
     */
    @XStreamAlias("return_code")
    private String returnCode;
    /**
     * 返回信息 String(128) OK 当return_code为FAIL时返回信息为错误原因 ，例如 签名失败 参数格式校验错误
     */
    ...
    /**
     * 小程序的APPID wx8888888888888888 微信支付分配的子商户号
     */
    @XStreamAlias("sub_appid")
    private String subAppId;
    /**
     * 子商户号 1900000109 微信支付分配的子商户号
     */
