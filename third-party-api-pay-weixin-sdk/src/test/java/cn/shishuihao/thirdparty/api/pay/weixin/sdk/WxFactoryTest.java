...
class WxFactoryTest {
    ...
    @Test
    void orderQuery() {
        WxPayOrderQueryResponse response = WxFactory.Payment.commonApi().orderQuery(WxPayOrderQueryRequest.builder()
                .appId("wx2421b1c4370ec43b")
                .mchId("10000100")
    ...
    @Test
    void refundQuery() {
        WxPayRefundQueryResponse response = WxFactory.Payment.commonApi().refundQuery(WxPayRefundQueryRequest.builder()
                .appId("wx2421b1c4370ec43b")
                .mchId("10000100")
