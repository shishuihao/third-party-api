...
public class TencentSmsClient {
    ...
    private final Map<AbstractApiProperties, SmsClient> map = new ConcurrentHashMap<>();

    public TencentSmsClient(TencentSmsProperties channelProperties) {
        this.channelProperties = channelProperties;
    }

    public SmsClient getClient(TencentSmsApiProperties properties) {
